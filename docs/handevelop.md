...
A memory map of *Handevelop* is given in [Table 1](#table-1-handevelop-memory-map). All named addresses are typed in capital letters. For multi-byte reads or writes, the most significant byte of data is at the least significant address, maintaining the standard of the 6502.
